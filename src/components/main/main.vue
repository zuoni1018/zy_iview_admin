<template>
  <Layout style="height: 100%" class="main">
    <Sider hide-trigger collapsible :width="262" :collapsed-width="64" v-model="collapsed"
      ...
      <side-menu accordion ref="sideMenu" :active-name="$route.name" :collapsed="collapsed"
        ...
        <!--logo-->
        <div style="width: 255px;height:64px;background: #E9EAEF;text-align: center;">
<!--          <img  style="height: auto;width: 175px;margin-top: 22px;margin-bottom: 22px" alt=""/>-->
          <img src="../../../public/LOGO10241024.png" style="height: 50px;width: 50px;margin-top: 6px" alt=""/>
        </div>
      </side-menu>
    </Sider>
    <Layout >
      ...
      <Content class="main-content-con">
        <Layout class="main-layout-con">
          ...
          <Content class="content-wrapper" id="main_content">
...
export default {
  ...
  mounted () {
    ...
    //     if (!this.collapsed) {
    //       // console.log("屏幕宽度小于700 且菜单是打开的 关闭菜单")
    //       this.collapsed = true
    //     }
    //   } else if (document.body.clientWidth > 1000) {
    //     if (this.collapsed) {
    //       // console.log("屏幕宽度小于1000 且菜单是关闭的的 打开菜单")
